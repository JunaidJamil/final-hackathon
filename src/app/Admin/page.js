...
import { createUserWithEmailAndPassword, doc, setDoc, db, auth, ref, uploadBytes, storage, collection, onSnapshot, getDownloadURL, updateDoc} from '../../../components/congif/firebase'
                        ...
                        <ul className="space-y-2 font-medium">
                            ...
                            <li>
                                <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="flex-1 ms-3 whitespace-nowrap" style={{ color: "grey", cursor: "pointer" }} onClick={() => {  router.push( "Attendence" )}}>Attendance</span>
                                </a>
                            </li>
                        </ul>
